...
tk.Label(root, text='目前時間', font=('Arial',30), foreground='#FFF', background='#000').pack()   # 放入第一個 Label 標籤
labTime = tk.Label(root, font=('Arial',55), text="", foreground='#FFF', background='#000') # 放入第二個 Label 標籤，內容是 a 變數
labTime.pack()
